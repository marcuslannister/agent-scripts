...
- Clones/pulls `nicobailon/visual-explainer` under `~/Projects`, links the skill into `~/.codex` with a relative symlink (`../visual-explainer/plugins/visual-explainer`), and copies its prompt templates into `~/.codex/prompts`.
