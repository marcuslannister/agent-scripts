...
| `waza:check` | tw93/Waza | plugin | Y | Y | ~7642 |
| `waza:health` | tw93/Waza | plugin | Y | Y | ~4927 |
| `waza:hunt` | tw93/Waza | plugin | Y | Y | ~4357 |
| `waza:learn` | tw93/Waza | plugin | Y | Y | ~2158 |
| `waza:read` | tw93/Waza | plugin | Y | Y | ~1862 |
| `waza:think` | tw93/Waza | plugin | Y | Y | ~2925 |
| `waza:ui` | tw93/Waza | plugin | Y | Y | ~3873 |
| `waza:write` | tw93/Waza | plugin | Y | Y | ~3647 |
