...
# Documented contract (CONTEXT.md, ADR-0005): a lock entry belonging to a known
# npx source, or to one nobody recognises, blocks the run for a human decision
# rather than being silently ignored or rewritten.
scan_skills_lock() {
