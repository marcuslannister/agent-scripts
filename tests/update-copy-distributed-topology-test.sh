...
for skill in docx loose-skill pdf; do test -f "$FIXTURE/skills/$skill/SKILL.md"; done
...
test ! -e "$FIXTURE/skills/pptx"
test ! -e "$FIXTURE/skills/skill-creator"
test ! -e "$FIXTURE/skills/xlsx"
...
grep -Fx 'skills/docx' "$FIXTURE/.gitignore" >/dev/null
...
grep -Fx 'selected destination changed' "$FIXTURE/skills/docx/SKILL.md" >/dev/null
...
grep -Fx 'tracked source update' "$KHAZIX_FIXTURE/skills/neat-freak/SKILL.md" >/dev/null
