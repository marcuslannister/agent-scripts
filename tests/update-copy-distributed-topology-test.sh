...
for skill in docx loose-skill pdf; do test -f "$FIXTURE/home/.claude/skills/$skill/SKILL.md"; done
for skill in docx loose-skill pptx skill-creator; do test -f "$FIXTURE/home/.agents/skills/$skill/SKILL.md"; done
