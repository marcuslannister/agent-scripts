...
Issue #18 removes the staged public per-source entrypoints at final cutover. Until then they remain callable but outside routine updates; they do not own root hygiene.
